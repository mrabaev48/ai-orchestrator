1. Feature summary
Implement gradual rollout rules by tenant/project/risk tier.

2. Relevant modules
- `packages/application/rollout/**`
- `packages/state/rollout/**`
...
- `packages/application/src/rollout/gradual-rollout-policy.ts`
- `packages/state/src/rollout/rollout-config.store.ts`
- `packages/application/src/rollout/*.test.ts`

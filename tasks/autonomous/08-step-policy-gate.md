1. Feature summary
Add mandatory per-step policy gate before any side-effectful action.
...
- `packages/execution/src/steps/step-policy-gate.ts`
- `packages/execution/src/steps/execute-step.ts`
- `packages/execution/src/steps/*.test.ts`

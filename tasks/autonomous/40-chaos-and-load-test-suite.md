1. Feature summary
Add chaos/load test suite for retries, cancel, and recovery.

2. Relevant modules
- `packages/execution/tests/chaos/**`
- `packages/execution/tests/load/**`
...
- `packages/execution/tests/chaos/retry-timeout-cancel.chaos.test.ts`
- `packages/execution/tests/load/autonomous-run.load.test.ts`
- `turbo.json`

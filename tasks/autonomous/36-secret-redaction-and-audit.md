1. Feature summary
Add secret redaction pipeline and immutable audit export.

2. Relevant modules
- `packages/tools/secrets/**`
- `packages/state/audit/**`
- `apps/api/audit/**`
...
- `packages/tools/src/secrets/redaction.ts`
- `packages/state/src/audit/immutable-audit-log.ts`
- `apps/api/src/routes/audit-export/**`

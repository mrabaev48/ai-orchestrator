1. Feature summary
Implement kill-switch and human override protocol.

2. Relevant modules
- `packages/application/safety-controls/**`
...
- `packages/application/src/safety/kill-switch.ts`
- `packages/application/src/safety/human-override.ts`
- `apps/api/src/routes/control-plane/**`

1. Feature summary
Implement pr_draft_prepare with evidence/review bundle.

2. Relevant modules
- `packages/execution/mutation/pr/**`
- `packages/tools/scm/**`
- `apps/api/pr/**`
...
- `packages/execution/src/mutation/stages/pr-draft-prepare.ts`
- `packages/tools/src/scm/create-draft-pr.ts`
- `apps/api/src/routes/pr/**`

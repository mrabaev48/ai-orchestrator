1. Feature summary
Implement autonomy level controller (L0-L5 policy mapping).

2. Relevant modules
- `packages/core/autonomy-levels/**`
- `packages/application/autonomy/**`
...
- `packages/core/src/autonomy/autonomy-level.ts`
- `packages/application/src/autonomy/level-controller.ts`
- `packages/application/src/autonomy/*.test.ts`

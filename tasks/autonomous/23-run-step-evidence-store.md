1. Feature summary
Implement append-only RunStepEvidence store with checksum.
...
- `packages/state/src/evidence/run-step-evidence.store.ts`
- `packages/execution/src/evidence/append-run-step-evidence.ts`

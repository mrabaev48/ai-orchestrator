1. Feature summary
Add non-bypass preflight policy gate in run startup use-case.

2. Relevant modules
- `packages/application/run-preflight/**`
- `packages/execution/gates/**`
...
- `packages/application/src/run/preflight.ts`
- `packages/execution/src/gates/preflight-policy-gate.ts`
- `packages/application/src/run/preflight.test.ts`

1. Feature summary
Add immutable approval request model and persistence port.

2. Relevant modules
- `packages/core/approval/**`
- `packages/state/approval/**`
...
- `packages/core/src/approval/approval-request.ts`
- `packages/state/src/approval/approval-store.ts`
- `packages/core/src/approval/*.test.ts`

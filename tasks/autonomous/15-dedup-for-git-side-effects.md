1. Feature summary
Guard push/PR creation with idempotency registry checks.

2. Relevant modules
- `packages/execution/mutation/**`
- `packages/tools/git/**`
...
- `packages/execution/src/mutation/push-stage.ts`
- `packages/execution/src/mutation/pr-stage.ts`

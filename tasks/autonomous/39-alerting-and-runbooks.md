1. Feature summary
Add SLO alerts and operator runbooks for major incident classes.
...
- `apps/observability/src/alerts/slo-alerts.ts`
- `docs/runbooks/autonomous-incidents.md`
- `apps/observability/src/alerts/*.test.ts`

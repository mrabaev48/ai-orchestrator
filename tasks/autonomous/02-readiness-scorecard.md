1. Feature summary
Define production readiness scorecard with measurable go/no-go criteria.

2. Relevant modules
- `apps/api/**`
- `packages/application/governance/**`
- `packages/state/read-models/**`
...
- `packages/application/src/governance/**`
- `packages/state/src/read-models/**`

1. Feature summary
Implement verification stage (build/lint/typecheck/test/security).

2. Relevant modules
- `packages/execution/mutation/verification/**`
...
- `packages/execution/src/mutation/stages/verification.ts`
- `packages/tools/src/verification/run-verification-suite.ts`
- `packages/execution/src/mutation/stages/verification.test.ts`

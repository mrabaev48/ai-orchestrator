1. Feature summary
Define initial SLI/SLO set and error budget policy for autonomous runs.

2. Relevant modules
- `apps/observability/**`
- `packages/application/slo/**`
- `packages/state/metrics/**`
...
- `packages/application/src/slo/**`
- `packages/state/src/metrics/**`

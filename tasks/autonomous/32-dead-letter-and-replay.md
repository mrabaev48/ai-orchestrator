1. Feature summary
Implement dead-letter path and controlled replay workflow.

2. Relevant modules
- `packages/execution/queue/**`
- `packages/state/queue/**`
...
- `packages/execution/src/queue/dead-letter-handler.ts`
- `packages/execution/src/queue/replay-controller.ts`
- `packages/state/src/queue/**`

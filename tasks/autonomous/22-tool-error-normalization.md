1. Feature summary
Normalize tool errors into structured retriable envelope.

2. Relevant modules
- `packages/tools/errors/**`
- `packages/core/errors/**`
- `packages/execution/tooling/**`
...
- `packages/tools/src/errors/tool-error-envelope.ts`
- `packages/execution/src/tools/normalize-error.ts`
- `packages/tools/src/errors/*.test.ts`

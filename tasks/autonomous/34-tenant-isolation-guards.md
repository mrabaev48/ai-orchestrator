1. Feature summary
Enforce tenant isolation across state/workspace/locks.

2. Relevant modules
- `packages/core/multitenancy/**`
- `packages/state/tenant-partitioning/**`
- `apps/api/auth/**`
...
- `packages/core/src/multitenancy/tenant-scope.ts`
- `packages/state/src/tenant/partition-guards.ts`

1. Feature summary
Implement canonical idempotency key builder for run actions.
...
- `packages/core/src/idempotency/build-key.ts`
- `packages/execution/src/idempotency/key-factory.ts`
- `packages/core/src/idempotency/*.test.ts`

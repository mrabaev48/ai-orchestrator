1. Feature summary
Enforce per-tool timeout and stage timeout boundaries.

2. Relevant modules
- `packages/execution/timeouts/**`
...
- `packages/execution/src/timeouts/stage-timeout.ts`
- `packages/tools/src/runtime/with-timeout.ts`
- `packages/execution/src/timeouts/*.test.ts`

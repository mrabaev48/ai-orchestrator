1. Feature summary
Standardize correlation IDs across run/task/step/tool events.

2. Relevant modules
- `packages/core/telemetry/**`
- `packages/execution/telemetry/**`
...
- `packages/core/src/telemetry/correlation-id.ts`
- `packages/execution/src/telemetry/attach-correlation.ts`
- `apps/api/src/routes/observability/**`

1. Feature summary
Propagate AbortSignal through execution and tool adapters.

2. Relevant modules
- `packages/execution/cancellation/**`
...
- `packages/execution/src/cancellation/propagate-abort.ts`
- `packages/tools/src/runtime/abort-aware-adapter.ts`
- `packages/execution/src/cancellation/*.test.ts`

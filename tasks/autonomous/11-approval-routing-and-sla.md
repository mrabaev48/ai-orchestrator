1. Feature summary
Implement approval routing, reminders, and SLA escalation hooks.

2. Relevant modules
- `packages/application/approval-routing/**`
- `apps/api/approval/**`
...
- `packages/application/src/approval/routing.ts`
- `packages/application/src/approval/sla-escalation.ts`
- `apps/api/src/routes/approval/**`

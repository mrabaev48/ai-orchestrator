1. Feature summary
Implement action-to-risk classification matrix with explicit ownership.

2. Relevant modules
- `packages/core/policy-risk/**`
- `packages/application/policy/**`
...
- `packages/core/src/policy/risk-classification.ts`
- `packages/application/src/policy/risk-mapper.ts`
- `packages/core/src/policy/risk-*.test.ts`

1. Feature summary
Introduce strongly consistent dedup registry port in state layer.

2. Relevant modules
- `packages/state/idempotency/**`
- `packages/application/idempotency/**`
...
- `packages/state/src/idempotency/dedup-registry.port.ts`
- `packages/state/src/idempotency/**`
- `packages/application/src/idempotency/**`

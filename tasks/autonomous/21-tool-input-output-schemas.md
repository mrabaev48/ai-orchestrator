1. Feature summary
Add strict input/output schema validation for tool adapters.

2. Relevant modules
- `packages/tools/schemas/**`
...
- `packages/tools/src/contracts/input-output-schemas.ts`
- `packages/tools/src/adapters/**`
- `packages/tools/src/contracts/*.test.ts`

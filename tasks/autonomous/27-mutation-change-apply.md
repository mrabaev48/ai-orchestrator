1. Feature summary
Implement change_apply stage with patch apply diagnostics.

2. Relevant modules
- `packages/execution/mutation/apply/**`
- `packages/tools/patch/**`
...
- `packages/execution/src/mutation/stages/change-apply.ts`
- `packages/tools/src/patch/apply-patch.ts`
- `packages/execution/src/mutation/stages/change-apply.test.ts`

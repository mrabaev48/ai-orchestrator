1. Feature summary
Add distributed lock + fencing token for single active run.

2. Relevant modules
- `packages/execution/locks/**`
- `packages/state/locks/**`
...
- `packages/execution/src/locks/fencing-token-guard.ts`
- `packages/state/src/locks/distributed-lock.store.ts`
- `packages/execution/src/locks/*.test.ts`

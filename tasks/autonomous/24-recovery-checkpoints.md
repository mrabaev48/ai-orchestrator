1. Feature summary
Persist recovery checkpoints and deterministic resume pointers.

2. Relevant modules
- `packages/state/recovery/**`
- `packages/execution/recovery/**`
...
- `packages/state/src/recovery/recovery-checkpoint.store.ts`
- `packages/execution/src/recovery/resume-from-checkpoint.ts`

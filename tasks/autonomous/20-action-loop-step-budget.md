1. Feature summary
Implement bounded ActionLoop step/wall-time budgets.

2. Relevant modules
- `packages/execution/action-loop/**`
- `packages/application/run-budget/**`
...
- `packages/execution/src/action-loop/agent-action-loop-engine.ts`
- `packages/application/src/run-budget/**`
- `packages/execution/src/action-loop/*.test.ts`

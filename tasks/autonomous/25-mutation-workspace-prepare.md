1. Feature summary
Implement workspace_prepare stage with snapshot creation.

2. Relevant modules
- `packages/execution/mutation/workspace/**`
...
- `packages/execution/src/mutation/stages/workspace-prepare.ts`
- `packages/tools/src/workspace/snapshot.ts`
- `packages/execution/src/mutation/stages/workspace-prepare.test.ts`

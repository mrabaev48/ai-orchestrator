1. Feature summary
Implement commit_prepare and push_prepare with compensation.

2. Relevant modules
- `packages/execution/mutation/commit-push/**`
- `packages/tools/git/**`
...
- `packages/execution/src/mutation/stages/commit-prepare.ts`
- `packages/execution/src/mutation/stages/push-prepare.ts`
- `packages/execution/src/mutation/stages/commit-push.test.ts`

1. Feature summary
Implement explicit closed transition table and guard API.

2. Relevant modules
- `packages/core/state-machine/**`
- `packages/application/state-transitions/**`
...
- `packages/core/src/state/transition-table.ts`
- `packages/core/src/state/assert-transition.ts`

1. Feature summary
Link approval outcomes to run evidence and policy decisions.

2. Relevant modules
- `packages/execution/evidence/**`
- `packages/state/evidence/**`
- `packages/application/approval/**`
...
- `packages/execution/src/evidence/link-approval.ts`
- `packages/state/src/evidence/evidence-store.ts`
- `packages/application/src/approval/decision-handler.ts`

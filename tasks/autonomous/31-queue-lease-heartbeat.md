1. Feature summary
Implement queue lease/heartbeat worker ownership protocol.

2. Relevant modules
- `packages/execution/worker/**`
- `packages/state/leases/**`
...
- `packages/execution/src/worker/lease-manager.ts`
- `packages/state/src/leases/lease-store.ts`
- `packages/execution/src/worker/lease-manager.test.ts`

# Task 03 — Introduce a complete role output schema registry
...
Goal:
Add a RoleOutputSchemaRegistry and enforce schema validation for every role/artifact before accepting results.

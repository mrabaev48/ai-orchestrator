# Task 08 — Expand smoke/e2e regression coverage for critical invariants
...
Goal:
Build an e2e suite for critical flows: select -> execute -> review -> test -> persist, including negative scenarios.

# Task 18 — Upgrade planner to a normalized backlog graph
...
Goal:
Make planner outputs include milestones/epics/features/tasks, dependency edges, risks, assumptions, and merge preview.
